...
const GuiaVisualEscalapp = () => {
  ...
  const ScoreExample = () => (
    <div className="bg-gradient-to-br from-green-50 to-primary/5 border border-green-200 rounded-lg p-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="font-semibold text-primary">Opción: Media</h4>
        </div>
  ...
  const renderContent = () => {
    switch (activeSection) {
      case "concepto":
        return (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-primary/5 to-indigo-50 border border-primary/20 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Torneo por Grupos de 4 Jugadores
              </h3>
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      Se juega a <strong>4 juegos</strong>
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-green-600" />
                    <span>
                      Diferencia de <strong>2 juegos</strong>
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-green-600" />
                    <span>
                      4-4 → <strong>Tie-break obligatorio</strong>
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <p className="text-sm text-yellow-700">
                Se guarda el marcador real del tie-break (ej: 7-5) pero para cómputo de puntos se trata
                como 5-4 para el ganador.
              </p>
            </div>
          </div>
        );
            ...
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 border border-orange-200 rounded-xl p-6">
              ...
              <div className="bg-white border rounded-lg p-4 mb-4">
                ...
                <p className="text-sm text-orange-700">
                  ...
                  Cuenta rondas consecutivas jugadas (sin usar comodín). Los puntos bonus son{" "}
                  <strong>configurables por el admin</strong>.
                </p>
              </div>
              <StreakVisualization />
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mb-4">
                <h4 className="font-semibold text-gray-900 mb-2">🎯 Configuración por Torneo</h4>
      ...
      case "comodin":
        return (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-purple-50 to-primary/5 border border-purple-200 rounded-xl p-6">
      ...
      case "movimientos":
        return (
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-indigo-50 to-primary/5 border border-indigo-200 rounded-xl p-6">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white border rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">⚖️ Orden en Nuevo Grupo</h4>
                  <p className="text-sm text-gray-700">
                    Se decide por <strong>puntos de la ronda que cierra</strong> (descendente)
                  </p>
                </div>
                <div className="bg-white border rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">🔒 Saturación</h4>
                  <p className="text-sm text-gray-700">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white border rounded-lg p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-semibold text-gray-900">Ranking Oficial</h4>
                  </div>
                ...
                <div className="bg-white border rounded-lg p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h4 className="font-semibold text-gray-900">Ranking Ironman</h4>
                  </div>
                  <ul className="space-y-2 text-sm text-gray-700">
              ...
              <div className="mt-6 bg-primary/5 border border-primary/20 rounded-lg p-4">
                <h4 className="font-semibold text-gray-900 mb-2">📊 Cálculo Actual</h4>
                <p className="text-sm text-gray-700">
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">PadelRise</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Guía Visual de PadelRise</h1>
