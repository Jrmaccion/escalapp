// components/dashboard/CurrentGroupCard.tsx
"use client";
...
import { Users, Trophy, ArrowRight, Crown, Flame, TrendingUp, TrendingDown, Minus } from "lucide-react";
...
export function CurrentGroupCard({ groupData }: Props) {
  const { number, level, roundNumber, members } = groupData;
